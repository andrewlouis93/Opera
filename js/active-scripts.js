		...
		$(function() {	
			...
			$(document).ready(function() {
				...
				if (sessvars.dampertype == "hyster"){
					hyst_graph1(sessvars.Tf_index[0],sessvars.Vf_index[0]);
					hyst_graph2(sessvars.Tf_index[0],sessvars.Vf_index[1]);
					hyst_graph3(sessvars.Tf_index[1],sessvars.Vf_index[0]);
					hyst_graph4(sessvars.Tf_index[1],sessvars.Vf_index[1]);
				}
				else{
